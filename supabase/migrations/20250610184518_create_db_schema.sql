...
with check ((EXISTS ( SELECT 1
  ...
  WHERE (club_managers_1.club_id = ( SELECT club_managers_2.club_id
           FROM club_managers club_managers_2
          WHERE (club_managers_2.user_id = ( SELECT users.id
                   FROM users
...
using ((auth.uid() = ( SELECT users.auth_id
   FROM users
  WHERE (users.id = payment_items.user_id))));
