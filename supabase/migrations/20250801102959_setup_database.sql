...
create type "public"."app_permission" as enum ('awards.write', 'clubs.read', 'clubs.write', 'club_managers.read', 'club_managers.write', 'details.read', 'details.write', 'memberships.read', 'memberships.write', 'users.write', 'messages.read', 'messages.write', 'invoices.read', 'invoices.write', 'payments.read', 'payments.write', 'supervisors.read', 'supervisors.write');
...
alter table "public"."memberships" add constraint "memberships_payment_id_fkey" FOREIGN KEY (payment_id) REFERENCES payments(id) ON DELETE SET NULL not valid;

alter table "public"."memberships" validate constraint "memberships_payment_id_fkey";
...
CREATE OR REPLACE FUNCTION public.create_membership_payment_item()
 RETURNS trigger
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO ''
...
CREATE TRIGGER trg_create_membership_payment_item BEFORE INSERT ON public.memberships FOR EACH ROW EXECUTE FUNCTION create_membership_payment_item();
