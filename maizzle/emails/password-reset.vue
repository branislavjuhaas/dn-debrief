<template>
  <Layout class="bg-gray-50 dark:bg-gray-950">
    <Preheader>Reset your [Brand Name] password.</Preheader>
      ...
      <Section class="rounded-b-lg bg-white px-6 py-16 dark:bg-gray-800">
        ...
        <Text class="mt-6 text-sm leading-5 text-gray-600 dark:text-gray-400">
          <Text as="span" class="text-sm font-semibold leading-5"
            >This link will expire in 15 minutes.</Text
          >
          <br />
        ...
        <Text class="text-xs/5 text-gray-600 break-all">
          <Text as="span" class="[word-break:break-word]"
            >If you're having trouble clicking the "Reset password" button, copy
            and paste the following URL into your web browser:</Text
          >
          <a
            href="https://maizzle.com/?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0"
            class="text-gray-800 underline"
            >https://maizzle.com/?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0</a
          >
        </Text>
      </Section>
